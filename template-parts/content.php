          ...
          <?php if(get_theme_mod('vw_hotel_toggle_postdate',true)==1 || get_theme_mod('vw_hotel_toggle_author',true)==1 || get_theme_mod('vw_hotel_toggle_comments',true)==1 || get_theme_mod('vw_hotel_toggle_time',true)==1){ ?>
            <div class="post-info">
              <?php if(get_theme_mod('vw_hotel_toggle_postdate',true)==1){ ?>
                <i class="<?php echo esc_attr(get_theme_mod('vw_hotel_toggle_postdate_icon','fas fa-calendar-alt')); ?>"></i><span class="entry-date"><a href="<?php echo esc_url( get_day_link( $vw_hotel_archive_year, $vw_hotel_archive_month, $vw_hotel_archive_day)); ?>"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span><span><?php echo esc_html(get_theme_mod('vw_hotel_meta_field_separator','|'));?></span>
              <?php } ?>

              <?php if(get_theme_mod('vw_hotel_toggle_author',true)==1){ ?>
                 <i class="<?php echo esc_attr(get_theme_mod('vw_hotel_toggle_author_icon','far fa-user')); ?>"></i><span class="entry-author"><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><?php the_author(); ?><span class="screen-reader-text"><?php the_author(); ?></span></a></span><span><?php echo esc_html(get_theme_mod('vw_hotel_meta_field_separator','|'));?></span>
              <?php } ?>

              <?php if(get_theme_mod('vw_hotel_toggle_comments',true)==1){ ?>
                 <i class="<?php echo esc_attr(get_theme_mod('vw_hotel_toggle_comments_icon','fa fa-comments')); ?>" aria-hidden="true"></i><span class="entry-comments"><?php comments_number( __('0 Comment','vw-hotel'), __('0 Comments','vw-hotel'), __('% Comments','vw-hotel') ); ?> </span><span><?php echo esc_html(get_theme_mod('vw_hotel_meta_field_separator','|'));?></span>
              <?php } ?>

              <?php if(get_theme_mod('vw_hotel_toggle_time',true)==1){ ?>
                 <i class="<?php echo esc_attr(get_theme_mod('vw_hotel_toggle_time_icon','fas fa-clock')); ?>"></i><span class="entry-time"><?php echo esc_html( get_the_time() ); ?></span>
              <?php } ?>
